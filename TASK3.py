...
video_path = r"C:\Users\ASUS\Downloads\Ronaldo real Madrid lineup 4k free clip _Clip for edits_.mp4"  # Replace with actual path
...
while video.isOpened():
    ...
    for (fx, fy, fw, fh) in faces:
        ...
        # Draw bounding box and add label if the score exceeds threshold
